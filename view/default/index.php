...
<html>
    <head>
        ...
        <link rel="stylesheet" href="view/default/style.css?<?= filemtime("view/default/style.css") ?>">
        <script src="view/default/functions.js?<?= filemtime("view/default/functions.js") ?>"></script>
    </head>
    <body>
        <fieldset>
